...
<head>
    ...
    <title>REGISTER ADMIN | SIHAKI POLITAP</title>
    <!-- Bootstrap CSS -->
    ...
    body {
        ...
        padding-top: 40px;
        padding-bottom: 40px;
        background-image: url("gambar/gambar3.jpeg");
    }
    </style>
</head>
<!-- ============================================================== -->
    ...
    <form method="POST" action="{{ route('postuser') }}" class="splash-container">
        ...
        <div class="card">
            <div class="card-header mb-0">
                <h3 class="text-center">REGISTRASI <br> ADMIN</h3>
            </div>
            <div class="card-body">
                ...
                <div class="form-group">
                    <label class="custom-control custom-checkbox">
                        <input class="custom-control-input" type="checkbox"><span class="custom-control-label">Dengan Membuat Akun, Anda Menyetujui <a href="/">Syarat Dan Ketentuan</a></span>
                    </label>
                </div>
