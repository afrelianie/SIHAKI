...
class DirekturpermohonanController extends Controller
{
    public function index()
    {
        $data['list_hakcipta'] = HakCipta::all();
        return view('direktur-cipta.pengajuan.index', $data);
    }
    public function create()
    {
        return view('direktur-cipta.pengajuan.create');
    }
    public function store(Request $request)
    {
        ...
        $hakcipta->save();
        return redirect('direktur-permohonan');
    }
    ...
    public function show(HakCipta $hakcipta)
    {
        ...
        return view('direktur-cipta.pengajuan.show', $data);
    }
}
